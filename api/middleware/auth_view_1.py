...
from models.user import UserRole, BrokerVerificationStatus, DocumentType
...
def render_auth_view():
    ...
    st.markdown(
        ...
        '<h2 style="color:#ecf0f1;margin:0;">Welcome to Smart Land Copilot</h2>'
        '<p style="color:#8b949e;margin-top:8px;">Select your account persona to continue</p>'
        '</div>',
    ...
    role_cards = [
        {
            ...
            "icon": "\U0001f4c8",
            "color": "#27ae60",
            "desc": "Track land pricing trends, infrastructure availability, and manage your investment portfolio with multi-use classification analysis.",
        },
        {
            ...
            "icon": "\U0001f3e0",
            "color": "#2980b9",
            "desc": "Register properties for Sale, Rent, or Portfolio Tracking. View the transparent Financial Cleared Matrix with Egyptian tax deductions.",
        },
        {
            ...
            "icon": "\U0001f4bc",
            "color": "#f39c12",
            "desc": "Manage listings, track delegated properties, and earn commissions. Requires brokerage license verification.",
        },
    ]
...
def _render_logged_in_state(user, user_svc):
    ...
    role_colors = {
        UserRole.BUYER_INVESTOR: "#27ae60",
        UserRole.SELLER_OWNER: "#2980b9",
        UserRole.CERTIFIED_BROKER: "#f39c12",
    }
    ...
    st.markdown(
        ...
        ">
            <div>
                ...
                {"<div style='color:#e74c3c;font-size:12px;margin-top:6px;font-weight:600;'>"
                 "Broker Status: " + user.broker_verification_status.value + "</div>"
    ...
    # Broker verification status detail
    if user.role == UserRole.CERTIFIED_BROKER and not user.is_broker_verified:
        st.markdown("<br>", unsafe_allow_html=True)
                ...
                for doc in status["documents"]:
                    ...
                    st.markdown(
                        ...
                        <div style="background:#1a1a2e;border-left:3px solid {doc_color};
                            ...
                            {"<br><small style='color:#e74c3c;'>Rejection: " + doc['rejection_reason'] + "</small>"
                             if doc['rejection_reason'] else ""}
                        </div>
                        """,
                        unsafe_allow_html=True,
                    )

            # Admin verification controls (for demo purposes)
            st.markdown("<br>", unsafe_allow_html=True)
                ...
                if not doc["verified"] and not doc["rejection_reason"]:
                    ...
                    with vc2:
                        if st.button(f"Reject {doc['document_id']}", key=f"reject_{doc['document_id']}"):
                            user_svc.verify_broker_document(
                                user.user_id, doc["document_id"],
                                approved=False, rejection_reason="Document unclear or incomplete",
                            )
